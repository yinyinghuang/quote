// pages/Home/category_brand/category_brand.js
...
Page({
  ...
  //获取筛选项选项值
  getCategoryFilterOption: function (category_id) {
    const _this = this
    comm.request({
      url: glbd.host + 'categories/get-category-brand?category_id=' + category_id,
      method: glbd.method,
