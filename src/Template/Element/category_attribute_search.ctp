...
<div class="demoTable">
  <form class="layui-form">
    <input type="hidden" name="search[category_id]" value="<?= $category_id?>" id="category_id">    
    <div class="layui-form-item">
      ...
      <div class="layui-inline">
        ...
        <div class="layui-input-block">
          <input type="text" name="search[attribute_name]" placeholder="" autocomplete="off" class="layui-input">
        </div>
      </div>
      <?php if (!$category_id): ?>        
        <div class="layui-inline">
    ...
    <div class="layui-form-item">
      <div class="layui-input-block">
        <button class="layui-btn layui-btn-sm" lay-submit lay-filter="search-categories-attributes">搜索</button>
      </div>
    </div>
  </form>
</div>