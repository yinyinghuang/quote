...
class ZonesController extends AppController
{
    ...
    public function view($id = null)
    {
        ...
        $zones      = $this->Zones->find('list')->where(['id' => $zone->id]);
        ...
        $searchTpl['group']['category_select'] = $this->getCasecadeTplParam('category_select', [
            'zone'     => [
                'zone_id'  => $zone->id,
                'disabled' => true,
                'options'  => $zones,
        ...
        $groupTableParams = [
            ...
            'tableFields' => [
                ['field' => '\'id\'', 'title' => '\'ID\'', 'fixed' => '\'left\'', 'unresize' => true, 'sort' => true],
                ['field' => '\'name\'', 'title' => '\'分组\'', 'unresize' => true, 'edit' => '\'text\''],
        ...
        $this->set(compact('zone', 'tableParams', 'active', 'searchTpl'));
    }
