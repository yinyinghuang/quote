...
class FansController extends AppController
{
    ...
    public function index()
    {
        $tableParams = [
            ...
            'tableFields' => [
                ...
                ['field' => '\'avatarUrl\'', 'title' => '\'头像\'', 'fixed' => '\'left\'', 'unresize' => true,'templet' => '(res) => (\'<img width="35" src="\'+res.avatarUrl+\'">\')','maxWidth' => 100, ],
    ...
    public function apiLists()
    {
        ...
        $this->getTableData(function () {
            ...
            $row->last_access = (new Time($row->last_access))->i18nFormat('yyyy-MM-dd HH:mm:ss');
            $row->sign_up = (new Time($row->sign_up))->i18nFormat('yyyy-MM-dd HH:mm:ss');
            return $row;
        });
    }
}
